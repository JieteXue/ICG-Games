...
class Button:
    ...
    def __init__(self, x, y, width, height, text, font_manager, icon=None):
        ...
        self.hovered = False
        self.enabled = True
        self.icon = icon  # Icon type: 'back' or 'home'
...
class InputHandler:
    ...
    def handle_mouse_click(self, event, position_rects, buttons):
        ...
        if buttons["back"].is_clicked(event):
            ...
            # Go back to main menu by running main.py
            pygame.quit()
            main.main()  # 调用main.py的主函数
            sys.exit()
...
class CardGame:
    ...
    def __init__(self):
        ...
        Select_Mode.set_global_references(self.screen, self.font_manager)
    ...
    def draw(self):
        ...
        try:
            ...
            # Draw navigation buttons (always visible)
